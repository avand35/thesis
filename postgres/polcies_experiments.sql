...
-- CREATE MATERIALIZED VIEW c_p2 AS 
-- SELECT c_custkey, c_nationkey, blur_phone(c_phone) as c_phone, bucketize(c_acctbal, 500.0) as c_acctbal, c_mktsegment, c_comment 
-- FROM customer;

-- CREATE MATERIALIZED VIEW c_p3 AS 
-- SELECT c_custkey, c_nationkey, suppress(c_phone) as c_phone, c_acctbal, suppress(c_mktsegment) as c_mktsegment, c_comment 
-- FROM customer;
